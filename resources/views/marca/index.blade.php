                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{route('marcas.edit',['marca'=>$marca])}}" method="get">
                                        ...
                                        @if ($marca->caracteristica->estado == 1)
                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal-{{$marca->id}}">Eliminar</button>                                    
                                        @else
                                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal-{{$marca->id}}">Restaurar</button>                                    
                                        @endif
                            ...
                            <div class="modal fade" id="exampleModal-{{$marca->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    ...
                                    <div class="modal-body">
                                        {{$marca->caracteristica->estado == 1 ? '¿Estas seguro de elminiar esta marca?' : '¿Estas seguro de restaurar esta marca?'}}
                                    </div>
