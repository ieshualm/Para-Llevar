        ...
        <form action="{{ route('marcas.update',['marca'=>$marca])}}" method="post">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" value="{{old('nombre',$marca->caracteristica->nombre)}}"> <!--Aqui cambiar para que coincida con la base de datos-->
                    @error('nombre')
