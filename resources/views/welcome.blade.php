...
<head>
    ...
    <meta name="author" content="Axel Leon" />
    <title>Soft Ease</title>
...
<body>
    ...
    <div id="carouselExample" class="carousel slide carousel-fade">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{asset('assets/img/CARR-1.png')}}" class="d-block w-100" alt="banner de invitacion">
            </div>
            <div class="carousel-item">
                <img src="{{asset('assets/img/CARR-2.png')}}" class="d-block w-100" alt="Banner de publicidad">
            </div>
        </div>
    ...
    <footer class="text-center text-white">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2024 Copyright:
            <a class="text-white" href="{{ asset('500') }}">softase.com</a>
        </div>
        <!-- Copyright -->
    </footer>
